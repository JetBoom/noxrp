...
if CLIENT then
	SWEP.PrintName = "'Scout' Light Sniper"
	...
	SWEP.BoneDeltaAngles = {Up = 0,Right = -5,Forward = 0,MU = -8,MR = 3,MF = -10,Scale = 0.8}
	
	SWEP.Ammo3DBone = "v_weapon.scout_Parent"
	SWEP.Ammo3DAng = Angle(0, 0, 0)
	SWEP.Ammo3DPos = Vector(-0.7, -3, -8)
	SWEP.Ammo3DScale = 0.015
end

SWEP.Item = "sniper_scout"
...
SWEP.ShootSound = Sound("Weapon_Scout.Single")
