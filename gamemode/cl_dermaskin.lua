...
SKIN.PrintName 		= "NoXRP Derma Skin"
SKIN.Author 		= ""
SKIN.DermaVersion	= 1
...
SKIN.frame_border				= Color( 255, 50, 50, 255 )
...
function SKIN:PaintFrame( panel, w, h )
	...
	if ( panel.m_bPaintShadow ) then
		...
		SKIN.tex.Shadow( -4, -4, w + 4, h + 4 );
		DisableClipping( false )
	
	end
	
	draw.SlantedRectHorizOffset(0, 0, w, 25, 1, Color(10, 10, 10, 200), Color(0, 0, 0, 255), 2, 2)
	draw.SlantedRectHorizOffset(0, 30, w, h - 30, 0, Color(10, 10, 10, 200), Color(0, 0, 0, 255), 2, 2)
end
...
function SKIN:PaintButton( panel, w, h )
	...
	if ( panel.Hovered ) then
		draw.SlantedRectHorizOffset(0, 0, w, h, 2, Color(30, 30, 30, 180), Color(0, 0, 0, 255), 2, 2)
	end
			
	draw.SlantedRectHorizOffset(0, 0, w, h, 2, Color(20, 20, 20, 180), Color(0, 0, 0, 255), 2, 2)
end
...
derma.DefineSkin( "noxrp", "The skin for noxrp", SKIN, "Default")
